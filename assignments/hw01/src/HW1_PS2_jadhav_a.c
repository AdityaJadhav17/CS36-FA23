...
/* Date : 09/12/2023                                         */
/* Program that maintains information about stocks.          */
/*															 */
/*************************************************************/
...
int main()
{
    ...
    scanf ("%f %f %f", &buy_price, &current_price, &y_fees);
    puts  (" ");
    ...
    ini_cost  = shares * buy_price;
    curr_cost = shares * current_price;
    profit_1  = curr_cost - ini_cost - y_fees;
    ...
    ini_cost  = shares * buy_price;
    curr_cost = shares * current_price;
    profit_2  = curr_cost - ini_cost - y_fees;
    ...
    ini_cost  = shares * buy_price;
    curr_cost = shares * current_price;
    profit_3  = curr_cost - ini_cost - y_fees;
    ...
    ini_cost  = shares * buy_price;
    curr_cost = shares * current_price;
    profit_4  = curr_cost - ini_cost - y_fees;
    ...
    ini_cost  = shares * buy_price;
    curr_cost = shares * current_price;
    profit_5  = curr_cost - ini_cost - y_fees;
    ...
    total_profit = profit_1 + profit_2 + profit_3 + profit_4 + profit_5;
